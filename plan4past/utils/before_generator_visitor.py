from pylogics.syntax.pltl import Before, Once, Since, PropositionalFalse, PropositionalTrue
...
def populate_dictionary(
    formula: object, before_gen: BeforeGenerator) -> None:
...
def _(
    _formula: Atomic, _before_gen: BeforeGenerator) -> None:
    """Populate dictionary for an atomic formula."""
    pass

@populate_dictionary.register
def _(
    _formula: PropositionalTrue, _before_gen: BeforeGenerator) -> None:
    """Populate dictionary for an atomic formula."""
    pass

@populate_dictionary.register
def _(
    _formula: PropositionalFalse, _before_gen: BeforeGenerator) -> None:
    """Populate dictionary for an atomic formula."""
    pass
...
@populate_dictionary.register
def _(
    formula: Not, before_gen: BeforeGenerator) -> None:
...
@populate_dictionary.register
def _(
    formula: Once, before_gen: BeforeGenerator) -> None:
...
@populate_dictionary.register
def _(
    formula: Before, before_gen: BeforeGenerator) -> None:
...
@populate_dictionary.register
def _(
    formula: Since, before_gen: BeforeGenerator) -> None:
    """Populate dictionary for a Before formula."""
    before_gen.add_qouted_atom(get_before_atom(formula))
...
@populate_dictionary.register
def _(
    formula: And, before_gen: BeforeGenerator) -> None:
...
@populate_dictionary.register
def _(
    formula: Or, before_gen: BeforeGenerator) -> None:
