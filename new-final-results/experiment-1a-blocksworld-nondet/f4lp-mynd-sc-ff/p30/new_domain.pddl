(define (domain blocks-domain)
	...
	(:types block)
	(:predicates (holding ?b - block) (emptyhand) (ontable ?b - block) (on ?b1 - block ?b2 - block) (clear ?b - block) (q1 ?b1-00 - block ?b2-01 - block ?b2-02 - block) (q2 ?b1-00 - block ?b2-01 - block ?b2-02 - block) (q3 ?b1-00 - block ?b2-01 - block ?b2-02 - block) (turnDomain))
	(:action pick-up
