(define (domain blocks-domain)
	...
	(:types block)
	(:predicates (holding ?b - block) (emptyhand) (ontable ?b - block) (on ?b1 - block ?b2 - block) (clear ?b - block) (q1 ?b1-00 - block ?b2-01 - block) (q2 ?b1-00 - block ?b2-01 - block) (turnDomain))
	(:action pick-up
	...
	(:action trans-0
		...
		:precondition (and (q1 ?b1-00 ?b2-01) (not (on ?b1-00 ?b2-01)) (not (turnDomain)))
		:effect (and (q1 ?b1-00 ?b2-01) (not (q2 ?b1-00 ?b2-01)) (turnDomain))
	)
	(:action trans-1
		:parameters (?b1-00 - block ?b2-01 - block)
		:precondition (and (or (and (q1 ?b1-00 ?b2-01) (on ?b1-00 ?b2-01)) (q2 ?b1-00 ?b2-01)) (not (turnDomain)))
		:effect (and (q2 ?b1-00 ?b2-01) (not (q1 ?b1-00 ?b2-01)) (turnDomain))
	)
)