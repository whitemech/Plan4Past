(define (domain blocks-domain)
	...
	(:action pick-up
		...
		:effect (and 
			...
			(when (and (prev_autstate q1) (not (on b4 b5)))
			 (and )
			) 
			(when (and (prev_autstate q1) (on b4 b5))
			 (and (not (prev_autstate q1)) (prev_autstate q3))
			) 
			(when (prev_autstate q2)
			 (and )
			) 
			(when (and (prev_autstate q3) (not (on b3 b4)))
			 (and )
			) 
			(when (and (prev_autstate q3) (on b3 b4))
			 (and (not (prev_autstate q3)) (prev_autstate q4))
			) 
			(when (and (prev_autstate q4) (not (on b2 b3)))
			 (and )
			) 
			(when (and (prev_autstate q4) (on b2 b3))
			 (and (not (prev_autstate q4)) (prev_autstate q5))
			) 
			(when (and (prev_autstate q5) (not (on b1 b2)))
			 (and )
			) 
			(when (and (prev_autstate q5) (on b1 b2))
			...
			(when (prev_autstate q7)
			 (and (not (prev_autstate q7)) (prev_autstate q2))
			) 
			(when (prev_autstate q0)
			 (and (not (prev_autstate q0)) (prev_autstate q1))
			) 
