(define (domain blocks-domain)
	...
	(:action pick-up
		...
		:effect (and 
			...
			(when (and (prev_autstate q1) (not (on b3 b4)))
			 (and )
			) 
			(when (and (prev_autstate q1) (on b3 b4))
			 (and (not (prev_autstate q1)) (prev_autstate q3))
			) 
			(when (prev_autstate q2)
			 (and )
			) 
			(when (and (prev_autstate q3) (not (on b2 b3)))
			 (and )
			) 
			(when (and (prev_autstate q3) (on b2 b3))
			 (and (not (prev_autstate q3)) (prev_autstate q4))
			) 
			(when (and (prev_autstate q4) (not (on b1 b2)))
			 (and )
			) 
			(when (and (prev_autstate q4) (on b1 b2))
