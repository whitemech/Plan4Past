(define (domain blocks-domain)
    ...
    (:types block)
    (:predicates (clear ?x) (emptyhand) (holding ?x) (on ?x ?y) (ontable ?x) (val_on_a_i) (val_on_b_c) (val_on_c_a) (val_on_d_b) (val_on_e_h) (val_on_f_e) (val_on_g_d) (val_on_g_d-and-on_d_b-and-on_b_c-and-on_c_a-and-on_a_i-and-on_i_f-and-on_f_e-and-on_e_h) (val_on_i_f))
    (:derived (val_on_a_i) (on a i))
     ...
     (:derived (val_on_g_d-and-on_d_b-and-on_b_c-and-on_c_a-and-on_a_i-and-on_i_f-and-on_f_e-and-on_e_h) (and (val_on_g_d) (val_on_d_b) (val_on_b_c) (val_on_c_a) (val_on_a_i) (val_on_i_f) (val_on_f_e) (val_on_e_h)))
