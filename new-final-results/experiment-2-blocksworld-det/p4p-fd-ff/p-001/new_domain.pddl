(define (domain blocks-domain)
    ...
    (:types block)
    (:predicates (clear ?x) (emptyhand) (holding ?x) (on ?x ?y) (ontable ?x) (val_on_b_a) (val_on_c_b) (val_on_d_c) (val_on_d_c-and-on_c_b-and-on_b_a))
    (:derived (val_on_b_a) (on b a))
     (:derived (val_on_c_b) (on c b))
     (:derived (val_on_d_c) (on d c))
     (:derived (val_on_d_c-and-on_c_b-and-on_b_a) (and (val_on_d_c) (val_on_c_b) (val_on_b_a)))
    (:action pick-up
        :parameters (?x)
