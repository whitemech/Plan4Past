(define (domain elevator)
    ...
    (:action board
        ...
        :effect (and (boarded ?p) (when (val_Oserved_p4) (Oserved_p4)) (when (val_Oserved_p16) (Oserved_p16)) (when (val_Oserved_p9) (Oserved_p9)) (when (val_Oserved_p12) (Oserved_p12)) (when (val_Oserved_p0) (Oserved_p0)) (when (val_Oserved_p8) (Oserved_p8)) (when (val_Oserved_p15) (Oserved_p15)) (when (val_Oserved_p7) (Oserved_p7)) (when (val_Oserved_p2) (Oserved_p2)) (when (val_Oserved_p10) (Oserved_p10)) (when (val_Oserved_p14) (Oserved_p14)) (when (val_Oserved_p11) (Oserved_p11)) (when (val_Oserved_p5) (Oserved_p5)) (when (val_Oserved_p3) (Oserved_p3)) (when (val_Oserved_p13) (Oserved_p13)) (when (val_Oserved_p17) (Oserved_p17)) (when (val_Oserved_p6) (Oserved_p6)) (when (val_Oserved_p1) (Oserved_p1)))
    )
     (:action depart
        :parameters (?f ?p)
        :precondition (and (lift-at ?f) (destin ?p ?f) (boarded ?p))
        :effect (and (and (not (boarded ?p)) (served ?p)) (when (val_Oserved_p4) (Oserved_p4)) (when (val_Oserved_p16) (Oserved_p16)) (when (val_Oserved_p9) (Oserved_p9)) (when (val_Oserved_p12) (Oserved_p12)) (when (val_Oserved_p0) (Oserved_p0)) (when (val_Oserved_p8) (Oserved_p8)) (when (val_Oserved_p15) (Oserved_p15)) (when (val_Oserved_p7) (Oserved_p7)) (when (val_Oserved_p2) (Oserved_p2)) (when (val_Oserved_p10) (Oserved_p10)) (when (val_Oserved_p14) (Oserved_p14)) (when (val_Oserved_p11) (Oserved_p11)) (when (val_Oserved_p5) (Oserved_p5)) (when (val_Oserved_p3) (Oserved_p3)) (when (val_Oserved_p13) (Oserved_p13)) (when (val_Oserved_p17) (Oserved_p17)) (when (val_Oserved_p6) (Oserved_p6)) (when (val_Oserved_p1) (Oserved_p1)))
    )
     (:action down
        :parameters (?f1 ?f2)
        :precondition (and (lift-at ?f1) (above ?f2 ?f1))
        :effect (and (and (lift-at ?f2) (not (lift-at ?f1))) (when (val_Oserved_p4) (Oserved_p4)) (when (val_Oserved_p16) (Oserved_p16)) (when (val_Oserved_p9) (Oserved_p9)) (when (val_Oserved_p12) (Oserved_p12)) (when (val_Oserved_p0) (Oserved_p0)) (when (val_Oserved_p8) (Oserved_p8)) (when (val_Oserved_p15) (Oserved_p15)) (when (val_Oserved_p7) (Oserved_p7)) (when (val_Oserved_p2) (Oserved_p2)) (when (val_Oserved_p10) (Oserved_p10)) (when (val_Oserved_p14) (Oserved_p14)) (when (val_Oserved_p11) (Oserved_p11)) (when (val_Oserved_p5) (Oserved_p5)) (when (val_Oserved_p3) (Oserved_p3)) (when (val_Oserved_p13) (Oserved_p13)) (when (val_Oserved_p17) (Oserved_p17)) (when (val_Oserved_p6) (Oserved_p6)) (when (val_Oserved_p1) (Oserved_p1)))
    )
     (:action up
        :parameters (?f1 ?f2)
