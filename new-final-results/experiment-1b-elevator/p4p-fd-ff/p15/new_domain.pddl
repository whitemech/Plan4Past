(define (domain elevator)
    ...
    (:predicates (Oserved_p0) (Oserved_p1) (Oserved_p10) (Oserved_p11) (Oserved_p12) (Oserved_p13) (Oserved_p14) (Oserved_p2) (Oserved_p3) (Oserved_p4) (Oserved_p5) (Oserved_p6) (Oserved_p7) (Oserved_p8) (Oserved_p9) (above ?floor1 ?floor2) (boarded ?person) (destin ?person ?floor) (lift-at ?floor) (not-boarded ?person) (not-served ?person) (origin ?person ?floor) (served ?person) (val_Oserved_p0) (val_Oserved_p0-and-Oserved_p1-and-Oserved_p2-and-Oserved_p3-and-Oserved_p4-and-Oserved_p5-and-Oserved_p6-and-Oserved_p7-and-Oserved_p8-and-Oserved_p9-and-Oserved_p10-and-Oserved_p11-and-Oserved_p12-and-Oserved_p13-and-Oserved_p14) (val_Oserved_p1) (val_Oserved_p10) (val_Oserved_p11) (val_Oserved_p12) (val_Oserved_p13) (val_Oserved_p14) (val_Oserved_p2) (val_Oserved_p3) (val_Oserved_p4) (val_Oserved_p5) (val_Oserved_p6) (val_Oserved_p7) (val_Oserved_p8) (val_Oserved_p9) (val_served_p0) (val_served_p1) (val_served_p10) (val_served_p11) (val_served_p12) (val_served_p13) (val_served_p14) (val_served_p2) (val_served_p3) (val_served_p4) (val_served_p5) (val_served_p6) (val_served_p7) (val_served_p8) (val_served_p9))
    (:derived (val_Oserved_p0) (or (val_served_p0) (Oserved_p0)))
     (:derived (val_Oserved_p0-and-Oserved_p1-and-Oserved_p2-and-Oserved_p3-and-Oserved_p4-and-Oserved_p5-and-Oserved_p6-and-Oserved_p7-and-Oserved_p8-and-Oserved_p9-and-Oserved_p10-and-Oserved_p11-and-Oserved_p12-and-Oserved_p13-and-Oserved_p14) (and (val_Oserved_p0) (val_Oserved_p1) (val_Oserved_p2) (val_Oserved_p3) (val_Oserved_p4) (val_Oserved_p5) (val_Oserved_p6) (val_Oserved_p7) (val_Oserved_p8) (val_Oserved_p9) (val_Oserved_p10) (val_Oserved_p11) (val_Oserved_p12) (val_Oserved_p13) (val_Oserved_p14)))
    ...
    (:action board
        ...
        :effect (and (boarded ?p) (when (val_Oserved_p12) (Oserved_p12)) (when (val_Oserved_p7) (Oserved_p7)) (when (val_Oserved_p8) (Oserved_p8)) (when (val_Oserved_p2) (Oserved_p2)) (when (val_Oserved_p5) (Oserved_p5)) (when (val_Oserved_p4) (Oserved_p4)) (when (val_Oserved_p1) (Oserved_p1)) (when (val_Oserved_p13) (Oserved_p13)) (when (val_Oserved_p3) (Oserved_p3)) (when (val_Oserved_p0) (Oserved_p0)) (when (val_Oserved_p9) (Oserved_p9)) (when (val_Oserved_p6) (Oserved_p6)) (when (val_Oserved_p14) (Oserved_p14)) (when (val_Oserved_p11) (Oserved_p11)) (when (val_Oserved_p10) (Oserved_p10)))
    )
     (:action depart
        :parameters (?f ?p)
