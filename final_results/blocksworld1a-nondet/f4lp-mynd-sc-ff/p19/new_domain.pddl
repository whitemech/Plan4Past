(define (domain blocks-domain)
	...
	(:types block)
	(:predicates (holding ?b - block) (emptyhand) (on-table ?b - block) (on ?b1 - block ?b2 - block) (clear ?b - block) (q1 ?b1-00 - block ?b2-01 - block ?b2-02 - block) (q2 ?b1-00 - block ?b2-01 - block ?b2-02 - block) (q3 ?b1-00 - block ?b2-01 - block ?b2-02 - block) (turnDomain))
	(:action pick-up
	...
	(:action trans-0
		:parameters (?b1-00 - block ?b2-01 - block ?b2-02 - block)
		:precondition (and (q1 ?b1-00 ?b2-01 ?b2-02) (not (on ?b2-01 ?b2-02)) (not (turnDomain)))
		:effect (and (q1 ?b1-00 ?b2-01 ?b2-02) (not (q2 ?b1-00 ?b2-01 ?b2-02)) (not (q3 ?b1-00 ?b2-01 ?b2-02)) (turnDomain))
	)
	(:action trans-1
		:parameters (?b1-00 - block ?b2-01 - block ?b2-02 - block)
		:precondition (and (or (and (q1 ?b1-00 ?b2-01 ?b2-02) (on ?b2-01 ?b2-02)) (and (q2 ?b1-00 ?b2-01 ?b2-02) (not (on ?b1-00 ?b2-01)))) (not (turnDomain)))
		:effect (and (q2 ?b1-00 ?b2-01 ?b2-02) (not (q1 ?b1-00 ?b2-01 ?b2-02)) (not (q3 ?b1-00 ?b2-01 ?b2-02)) (turnDomain))
	)
	(:action trans-2
		:parameters (?b1-00 - block ?b2-01 - block ?b2-02 - block)
		:precondition (and (or (and (q2 ?b1-00 ?b2-01 ?b2-02) (on ?b1-00 ?b2-01)) (q3 ?b1-00 ?b2-01 ?b2-02)) (not (turnDomain)))
		:effect (and (q3 ?b1-00 ?b2-01 ?b2-02) (not (q1 ?b1-00 ?b2-01 ?b2-02)) (not (q2 ?b1-00 ?b2-01 ?b2-02)) (turnDomain))
	)
)