(define (domain blocks-domain)
    ...
    (:types block)
    (:predicates (Oon_b1_b2) (Oon_b2_b3-and-YOon_b1_b2) (Oon_b3_b4-and-YOon_b2_b3-and-YOon_b1_b2) (act) (clear ?b) (emptyhand) (holding ?b) (on ?b1 ?b2) (on-table ?b) (val_Oon_b1_b2) (val_Oon_b2_b3-and-YOon_b1_b2) (val_Oon_b3_b4-and-YOon_b2_b3-and-YOon_b1_b2) (val_YOon_b1_b2) (val_YOon_b2_b3-and-YOon_b1_b2) (val_on_b1_b2) (val_on_b2_b3) (val_on_b2_b3-and-YOon_b1_b2) (val_on_b3_b4) (val_on_b3_b4-and-YOon_b2_b3-and-YOon_b1_b2))
    ...
    (:action pick-tower
     ...
     (:action prog
        ...
        :effect (and (when (val_Oon_b3_b4-and-YOon_b2_b3-and-YOon_b1_b2) (Oon_b3_b4-and-YOon_b2_b3-and-YOon_b1_b2)) (when (val_Oon_b1_b2) (Oon_b1_b2)) (when (val_Oon_b2_b3-and-YOon_b1_b2) (Oon_b2_b3-and-YOon_b1_b2)) (act))
    )
     (:action put-down
        :parameters (?b)
