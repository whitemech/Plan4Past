(define (domain blocks-domain)
    ...
    (:types block)
    (:predicates (act) (clear ?b) (emptyhand) (holding ?b) (on ?b1 ?b2) (on-table ?b) (val_clear_b1) (val_clear_b6) (val_emptyhand) (val_emptyhand-and-on_b1_b7-and-on_b2_b8-and-on_b3_b10-and-on-table_b4-and-on_b5_b4-and-on_b6_b9-and-on_b7_b2-and-on_b8_b3-and-on_b9_b5-and-on-table_b10-and-clear_b1-and-clear_b6) (val_on-table_b10) (val_on-table_b4) (val_on_b1_b7) (val_on_b2_b8) (val_on_b3_b10) (val_on_b5_b4) (val_on_b6_b9) (val_on_b7_b2) (val_on_b8_b3) (val_on_b9_b5))
    (:derived (val_clear_b1) (clear b1))
     (:derived (val_clear_b6) (clear b6))
     (:derived (val_emptyhand) (emptyhand))
     (:derived (val_emptyhand-and-on_b1_b7-and-on_b2_b8-and-on_b3_b10-and-on-table_b4-and-on_b5_b4-and-on_b6_b9-and-on_b7_b2-and-on_b8_b3-and-on_b9_b5-and-on-table_b10-and-clear_b1-and-clear_b6) (and (val_emptyhand) (val_on_b1_b7) (val_on_b2_b8) (val_on_b3_b10) (val_on-table_b4) (val_on_b5_b4) (val_on_b6_b9) (val_on_b7_b2) (val_on_b8_b3) (val_on_b9_b5) (val_on-table_b10) (val_clear_b1) (val_clear_b6)))
     (:derived (val_on-table_b10) (on-table b10))
     (:derived (val_on-table_b4) (on-table b4))
     (:derived (val_on_b1_b7) (on b1 b7))
     (:derived (val_on_b2_b8) (on b2 b8))
     (:derived (val_on_b3_b10) (on b3 b10))
     (:derived (val_on_b5_b4) (on b5 b4))
     (:derived (val_on_b6_b9) (on b6 b9))
