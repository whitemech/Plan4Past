(define (domain blocks-domain)
    ...
    (:types block)
    (:predicates (act) (clear ?b) (emptyhand) (holding ?b) (on ?b1 ?b2) (on-table ?b) (val_clear_b1) (val_clear_b3) (val_clear_b4) (val_emptyhand) (val_emptyhand-and-on_b1_b2-and-on-table_b2-and-on_b3_b5-and-on-table_b4-and-on-table_b5-and-clear_b1-and-clear_b3-and-clear_b4) (val_on-table_b2) (val_on-table_b4) (val_on-table_b5) (val_on_b1_b2) (val_on_b3_b5))
    (:derived (val_clear_b1) (clear b1))
     (:derived (val_clear_b3) (clear b3))
     (:derived (val_clear_b4) (clear b4))
     (:derived (val_emptyhand) (emptyhand))
     (:derived (val_emptyhand-and-on_b1_b2-and-on-table_b2-and-on_b3_b5-and-on-table_b4-and-on-table_b5-and-clear_b1-and-clear_b3-and-clear_b4) (and (val_emptyhand) (val_on_b1_b2) (val_on-table_b2) (val_on_b3_b5) (val_on-table_b4) (val_on-table_b5) (val_clear_b1) (val_clear_b3) (val_clear_b4)))
