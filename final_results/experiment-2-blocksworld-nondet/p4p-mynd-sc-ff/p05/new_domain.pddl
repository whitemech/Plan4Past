(define (domain blocks-domain)
    ...
    (:types block)
    (:predicates (act) (clear ?b) (emptyhand) (holding ?b) (on ?b1 ?b2) (on-table ?b) (val_clear_b2) (val_clear_b5) (val_emptyhand) (val_emptyhand-and-on_b1_b3-and-on_b2_b4-and-on-table_b3-and-on_b4_b1-and-on-table_b5-and-clear_b2-and-clear_b5) (val_on-table_b3) (val_on-table_b5) (val_on_b1_b3) (val_on_b2_b4) (val_on_b4_b1))
    (:derived (val_clear_b2) (clear b2))
     (:derived (val_clear_b5) (clear b5))
     (:derived (val_emptyhand) (emptyhand))
     (:derived (val_emptyhand-and-on_b1_b3-and-on_b2_b4-and-on-table_b3-and-on_b4_b1-and-on-table_b5-and-clear_b2-and-clear_b5) (and (val_emptyhand) (val_on_b1_b3) (val_on_b2_b4) (val_on-table_b3) (val_on_b4_b1) (val_on-table_b5) (val_clear_b2) (val_clear_b5)))
