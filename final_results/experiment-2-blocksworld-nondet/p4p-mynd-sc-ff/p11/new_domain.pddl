(define (domain blocks-domain)
    ...
    (:types block)
    (:predicates (act) (clear ?b) (emptyhand) (holding ?b) (on ?b1 ?b2) (on-table ?b) (val_clear_b2) (val_clear_b3) (val_emptyhand) (val_emptyhand-and-on_b1_b9-and-on-table_b2-and-on_b3_b1-and-on_b4_b7-and-on_b5_b4-and-on_b6_b8-and-on_b7_b10-and-on_b8_b5-and-on_b9_b6-and-on-table_b10-and-clear_b2-and-clear_b3) (val_on-table_b10) (val_on-table_b2) (val_on_b1_b9) (val_on_b3_b1) (val_on_b4_b7) (val_on_b5_b4) (val_on_b6_b8) (val_on_b7_b10) (val_on_b8_b5) (val_on_b9_b6))
    (:derived (val_clear_b2) (clear b2))
     (:derived (val_clear_b3) (clear b3))
     (:derived (val_emptyhand) (emptyhand))
     (:derived (val_emptyhand-and-on_b1_b9-and-on-table_b2-and-on_b3_b1-and-on_b4_b7-and-on_b5_b4-and-on_b6_b8-and-on_b7_b10-and-on_b8_b5-and-on_b9_b6-and-on-table_b10-and-clear_b2-and-clear_b3) (and (val_emptyhand) (val_on_b1_b9) (val_on-table_b2) (val_on_b3_b1) (val_on_b4_b7) (val_on_b5_b4) (val_on_b6_b8) (val_on_b7_b10) (val_on_b8_b5) (val_on_b9_b6) (val_on-table_b10) (val_clear_b2) (val_clear_b3)))
     ...
     (:derived (val_on_b6_b8) (on b6 b8))
     (:derived (val_on_b7_b10) (on b7 b10))
