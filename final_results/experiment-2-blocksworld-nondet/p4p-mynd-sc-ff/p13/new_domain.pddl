(define (domain blocks-domain)
    ...
    (:types block)
    (:predicates (act) (clear ?b) (emptyhand) (holding ?b) (on ?b1 ?b2) (on-table ?b) (val_clear_b1) (val_clear_b2) (val_clear_b9) (val_emptyhand) (val_emptyhand-and-on_b1_b7-and-on_b2_b8-and-on_b3_b10-and-on-table_b4-and-on_b5_b4-and-on_b6_b3-and-on_b7_b6-and-on-table_b8-and-on-table_b9-and-on_b10_b5-and-clear_b1-and-clear_b2-and-clear_b9) (val_on-table_b4) (val_on-table_b8) (val_on-table_b9) (val_on_b10_b5) (val_on_b1_b7) (val_on_b2_b8) (val_on_b3_b10) (val_on_b5_b4) (val_on_b6_b3) (val_on_b7_b6))
    (:derived (val_clear_b1) (clear b1))
     (:derived (val_clear_b2) (clear b2))
     (:derived (val_clear_b9) (clear b9))
     (:derived (val_emptyhand) (emptyhand))
     (:derived (val_emptyhand-and-on_b1_b7-and-on_b2_b8-and-on_b3_b10-and-on-table_b4-and-on_b5_b4-and-on_b6_b3-and-on_b7_b6-and-on-table_b8-and-on-table_b9-and-on_b10_b5-and-clear_b1-and-clear_b2-and-clear_b9) (and (val_emptyhand) (val_on_b1_b7) (val_on_b2_b8) (val_on_b3_b10) (val_on-table_b4) (val_on_b5_b4) (val_on_b6_b3) (val_on_b7_b6) (val_on-table_b8) (val_on-table_b9) (val_on_b10_b5) (val_clear_b1) (val_clear_b2) (val_clear_b9)))
