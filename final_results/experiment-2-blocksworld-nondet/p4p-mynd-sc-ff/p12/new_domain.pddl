(define (domain blocks-domain)
    ...
    (:types block)
    (:predicates (act) (clear ?b) (emptyhand) (holding ?b) (on ?b1 ?b2) (on-table ?b) (val_clear_b5) (val_clear_b6) (val_emptyhand) (val_emptyhand-and-on_b1_b3-and-on_b2_b9-and-on-table_b3-and-on_b4_b10-and-on_b5_b7-and-on_b6_b4-and-on-table_b7-and-on_b8_b2-and-on_b9_b1-and-on_b10_b8-and-clear_b5-and-clear_b6) (val_on-table_b3) (val_on-table_b7) (val_on_b10_b8) (val_on_b1_b3) (val_on_b2_b9) (val_on_b4_b10) (val_on_b5_b7) (val_on_b6_b4) (val_on_b8_b2) (val_on_b9_b1))
    (:derived (val_clear_b5) (clear b5))
     (:derived (val_clear_b6) (clear b6))
     (:derived (val_emptyhand) (emptyhand))
     (:derived (val_emptyhand-and-on_b1_b3-and-on_b2_b9-and-on-table_b3-and-on_b4_b10-and-on_b5_b7-and-on_b6_b4-and-on-table_b7-and-on_b8_b2-and-on_b9_b1-and-on_b10_b8-and-clear_b5-and-clear_b6) (and (val_emptyhand) (val_on_b1_b3) (val_on_b2_b9) (val_on-table_b3) (val_on_b4_b10) (val_on_b5_b7) (val_on_b6_b4) (val_on-table_b7) (val_on_b8_b2) (val_on_b9_b1) (val_on_b10_b8) (val_clear_b5) (val_clear_b6)))
     (:derived (val_on-table_b3) (on-table b3))
     (:derived (val_on-table_b7) (on-table b7))
     (:derived (val_on_b10_b8) (on b10 b8))
     (:derived (val_on_b1_b3) (on b1 b3))
     (:derived (val_on_b2_b9) (on b2 b9))
     (:derived (val_on_b4_b10) (on b4 b10))
     (:derived (val_on_b5_b7) (on b5 b7))
     (:derived (val_on_b6_b4) (on b6 b4))
     (:derived (val_on_b8_b2) (on b8 b2))
