(define (domain blocks-domain)
    ...
    (:types block)
    (:predicates (act) (clear ?b) (emptyhand) (holding ?b) (on ?b1 ?b2) (on-table ?b) (val_clear_b1) (val_clear_b2) (val_emptyhand) (val_emptyhand-and-on-table_b1-and-on_b2_b5-and-on_b3_b4-and-on-table_b4-and-on_b5_b3-and-clear_b1-and-clear_b2) (val_on-table_b1) (val_on-table_b4) (val_on_b2_b5) (val_on_b3_b4) (val_on_b5_b3))
    (:derived (val_clear_b1) (clear b1))
     (:derived (val_clear_b2) (clear b2))
     (:derived (val_emptyhand) (emptyhand))
     (:derived (val_emptyhand-and-on-table_b1-and-on_b2_b5-and-on_b3_b4-and-on-table_b4-and-on_b5_b3-and-clear_b1-and-clear_b2) (and (val_emptyhand) (val_on-table_b1) (val_on_b2_b5) (val_on_b3_b4) (val_on-table_b4) (val_on_b5_b3) (val_clear_b1) (val_clear_b2)))
