(define (domain blocks-domain)
    ...
    (:types block)
    (:predicates (act) (clear ?b) (emptyhand) (holding ?b) (on ?b1 ?b2) (on-table ?b) (val_clear_b10) (val_clear_b12) (val_clear_b13) (val_clear_b3) (val_clear_b6) (val_emptyhand) (val_emptyhand-and-on-table_b1-and-on_b2_b11-and-on_b3_b15-and-on_b4_b1-and-on-table_b5-and-on_b6_b14-and-on_b7_b4-and-on_b8_b7-and-on-table_b9-and-on-table_b10-and-on_b11_b9-and-on_b12_b2-and-on-table_b13-and-on_b14_b5-and-on_b15_b8-and-clear_b3-and-clear_b6-and-clear_b10-and-clear_b12-and-clear_b13) (val_on-table_b1) (val_on-table_b10) (val_on-table_b13) (val_on-table_b5) (val_on-table_b9) (val_on_b11_b9) (val_on_b12_b2) (val_on_b14_b5) (val_on_b15_b8) (val_on_b2_b11) (val_on_b3_b15) (val_on_b4_b1) (val_on_b6_b14) (val_on_b7_b4) (val_on_b8_b7))
    (:derived (val_clear_b10) (clear b10))
     ...
     (:derived (val_emptyhand-and-on-table_b1-and-on_b2_b11-and-on_b3_b15-and-on_b4_b1-and-on-table_b5-and-on_b6_b14-and-on_b7_b4-and-on_b8_b7-and-on-table_b9-and-on-table_b10-and-on_b11_b9-and-on_b12_b2-and-on-table_b13-and-on_b14_b5-and-on_b15_b8-and-clear_b3-and-clear_b6-and-clear_b10-and-clear_b12-and-clear_b13) (and (val_emptyhand) (val_on-table_b1) (val_on_b2_b11) (val_on_b3_b15) (val_on_b4_b1) (val_on-table_b5) (val_on_b6_b14) (val_on_b7_b4) (val_on_b8_b7) (val_on-table_b9) (val_on-table_b10) (val_on_b11_b9) (val_on_b12_b2) (val_on-table_b13) (val_on_b14_b5) (val_on_b15_b8) (val_clear_b3) (val_clear_b6) (val_clear_b10) (val_clear_b12) (val_clear_b13)))
     ...
     (:derived (val_on_b11_b9) (on b11 b9))
     (:derived (val_on_b12_b2) (on b12 b2))
     (:derived (val_on_b14_b5) (on b14 b5))
     (:derived (val_on_b15_b8) (on b15 b8))
     (:derived (val_on_b2_b11) (on b2 b11))
     (:derived (val_on_b3_b15) (on b3 b15))
     (:derived (val_on_b4_b1) (on b4 b1))
     (:derived (val_on_b6_b14) (on b6 b14))
