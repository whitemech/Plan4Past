(define (domain blocks-domain)
    ...
    (:types block)
    (:predicates (act) (clear ?b) (emptyhand) (holding ?b) (on ?b1 ?b2) (on-table ?b) (val_clear_b3) (val_clear_b4) (val_clear_b7) (val_clear_b9) (val_emptyhand) (val_emptyhand-and-on_b1_b8-and-on-table_b2-and-on_b3_b6-and-on_b4_b2-and-on-table_b5-and-on_b6_b10-and-on_b7_b1-and-on_b8_b5-and-on-table_b9-and-on-table_b10-and-clear_b3-and-clear_b4-and-clear_b7-and-clear_b9) (val_on-table_b10) (val_on-table_b2) (val_on-table_b5) (val_on-table_b9) (val_on_b1_b8) (val_on_b3_b6) (val_on_b4_b2) (val_on_b6_b10) (val_on_b7_b1) (val_on_b8_b5))
    (:derived (val_clear_b3) (clear b3))
     ...
     (:derived (val_emptyhand-and-on_b1_b8-and-on-table_b2-and-on_b3_b6-and-on_b4_b2-and-on-table_b5-and-on_b6_b10-and-on_b7_b1-and-on_b8_b5-and-on-table_b9-and-on-table_b10-and-clear_b3-and-clear_b4-and-clear_b7-and-clear_b9) (and (val_emptyhand) (val_on_b1_b8) (val_on-table_b2) (val_on_b3_b6) (val_on_b4_b2) (val_on-table_b5) (val_on_b6_b10) (val_on_b7_b1) (val_on_b8_b5) (val_on-table_b9) (val_on-table_b10) (val_clear_b3) (val_clear_b4) (val_clear_b7) (val_clear_b9)))
     ...
     (:derived (val_on_b3_b6) (on b3 b6))
     (:derived (val_on_b4_b2) (on b4 b2))
     (:derived (val_on_b6_b10) (on b6 b10))
     (:derived (val_on_b7_b1) (on b7 b1))
     (:derived (val_on_b8_b5) (on b8 b5))
    (:action pick-tower
        :parameters (?b1 ?b2 ?b3)
