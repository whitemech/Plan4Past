(define (domain blocks-domain)
    ...
    (:types block)
    (:predicates (act) (clear ?b) (emptyhand) (holding ?b) (on ?b1 ?b2) (on-table ?b) (val_clear_b3) (val_clear_b5) (val_clear_b8) (val_emptyhand) (val_emptyhand-and-on-table_b1-and-on_b2_b9-and-on_b3_b7-and-on_b4_b10-and-on_b5_b2-and-on_b6_b1-and-on-table_b7-and-on_b8_b4-and-on-table_b9-and-on_b10_b6-and-clear_b3-and-clear_b5-and-clear_b8) (val_on-table_b1) (val_on-table_b7) (val_on-table_b9) (val_on_b10_b6) (val_on_b2_b9) (val_on_b3_b7) (val_on_b4_b10) (val_on_b5_b2) (val_on_b6_b1) (val_on_b8_b4))
    (:derived (val_clear_b3) (clear b3))
     (:derived (val_clear_b5) (clear b5))
     (:derived (val_clear_b8) (clear b8))
     (:derived (val_emptyhand) (emptyhand))
     (:derived (val_emptyhand-and-on-table_b1-and-on_b2_b9-and-on_b3_b7-and-on_b4_b10-and-on_b5_b2-and-on_b6_b1-and-on-table_b7-and-on_b8_b4-and-on-table_b9-and-on_b10_b6-and-clear_b3-and-clear_b5-and-clear_b8) (and (val_emptyhand) (val_on-table_b1) (val_on_b2_b9) (val_on_b3_b7) (val_on_b4_b10) (val_on_b5_b2) (val_on_b6_b1) (val_on-table_b7) (val_on_b8_b4) (val_on-table_b9) (val_on_b10_b6) (val_clear_b3) (val_clear_b5) (val_clear_b8)))
     ...
     (:derived (val_on_b4_b10) (on b4 b10))
     (:derived (val_on_b5_b2) (on b5 b2))
