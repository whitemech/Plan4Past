(define (domain triangle-tire)
	...
	(:action move-car
		...
		:effect (and 
			...
			(when (and (prev_autstate q5) (not (vehicleat l2x2)))
			 (and )
			) 
			(when (and (prev_autstate q5) (vehicleat l2x2))
			 (and (not (prev_autstate q5)) (prev_autstate q6))
			) 
			(when (and (prev_autstate q6) (not (vehicleat l1x3)))
			 (and )
			) 
			(when (and (prev_autstate q6) (vehicleat l1x3))
