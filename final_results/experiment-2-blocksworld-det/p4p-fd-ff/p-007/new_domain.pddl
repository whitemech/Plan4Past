(define (domain blocks-domain)
    ...
    (:types block)
    (:predicates (clear ?x) (emptyhand) (holding ?x) (on ?x ?y) (ontable ?x) (val_on_a_e) (val_on_b_a) (val_on_c_b) (val_on_c_b-and-on_b_a-and-on_a_e-and-on_e_f-and-on_f_d) (val_on_e_f) (val_on_f_d))
    (:derived (val_on_a_e) (on a e))
     (:derived (val_on_b_a) (on b a))
     (:derived (val_on_c_b) (on c b))
     (:derived (val_on_c_b-and-on_b_a-and-on_a_e-and-on_e_f-and-on_f_d) (and (val_on_c_b) (val_on_b_a) (val_on_a_e) (val_on_e_f) (val_on_f_d)))
