(define (problem bw_15)
  (:domain blocks-domain)
  (:objects b1 b2 b3 b4 b5 b6 b7 b8 b9 b10 b11 b12 b13 b14 b15 - block)
  (:init (emptyhand) (ontable b1) (ontable b2) (ontable b3) (ontable b4) (ontable b5) (ontable b6) (ontable b7) (ontable b8) (ontable b9) (ontable b10) (ontable b11) (ontable b12) (ontable b13) (ontable b14) (ontable b15) (clear b1) (clear b2) (clear b3) (clear b4) (clear b5) (clear b6) (clear b7) (clear b8) (clear b9) (clear b10) (clear b11) (clear b12) (clear b13) (clear b14) (clear b15))
 ...
 (:goal (and 
            ...
            (eventually (and (on b2 b1) (next 
                (eventually (and (on b3 b2) 
                    (next (eventually (on b5 b4))) (next (eventually (on b7 b6))) (next (eventually (on b9 b8))) (next (eventually (on b11 b10))) (next (eventually (on b13 b12))) (next (eventually (on b15 b14)))
                )))))
