...
(:init
 ...
 (:goal (and 
(always (or (not (at rover1 waypoint13)) (eventually (calibrated camera5 rover1))))
(always (or (not (at rover2 waypoint13)) (eventually (calibrated camera6 rover2))))
(always (or (not (at rover3 waypoint13)) (and (eventually (calibrated camera1 rover3)) (eventually (calibrated camera3 rover3)))))
(always (or (not (at rover4 waypoint13)) (eventually (calibrated camera0 rover4))))
(always (or (not (at rover5 waypoint13)) (and (eventually (calibrated camera2 rover5)) (eventually (calibrated camera4 rover5)))))
(until (not (communicated_soil_data waypoint5)) (communicated_soil_data waypoint14))
(until (not (communicated_soil_data waypoint2)) (communicated_soil_data waypoint5))
(until (not (communicated_soil_data waypoint3)) (communicated_soil_data waypoint2))
(until (not (communicated_rock_data waypoint3)) (communicated_soil_data waypoint3))
(until (not (communicated_rock_data waypoint5)) (communicated_rock_data waypoint3))
(until (not (communicated_rock_data waypoint12)) (communicated_rock_data waypoint5))
(until (not (communicated_rock_data waypoint9)) (communicated_rock_data waypoint12))
(until (not (communicated_image_data objective2 colour)) (communicated_rock_data waypoint9))
(until (not (communicated_image_data objective2 low_res)) (communicated_image_data objective2 colour))
(until (not (communicated_image_data objective3 colour)) (communicated_image_data objective2 low_res))
(until (not (communicated_image_data objective5 colour)) (communicated_image_data objective3 colour))
(until (not (communicated_image_data objective4 colour)) (communicated_image_data objective5 colour))
(eventually (communicated_image_data objective4 colour)))) 
