...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint9)) (eventually (calibrated camera6 rover0))))
(always (or (not (at rover1 waypoint9)) (eventually (calibrated camera7 rover1))))
(always (or (not (at rover2 waypoint9)) (eventually (calibrated camera8 rover2))))
(always (or (not (at rover3 waypoint9)) (eventually (calibrated camera3 rover3))))
(always (or (not (at rover4 waypoint9)) (eventually (calibrated camera5 rover4))))
(always (or (not (at rover5 waypoint9)) (eventually (calibrated camera1 rover5))))
(always (or (not (at rover6 waypoint9)) (eventually (calibrated camera2 rover6))))
(always (or (not (at rover7 waypoint9)) (eventually (calibrated camera4 rover7))))
(always (or (not (at rover8 waypoint9)) (eventually (calibrated camera0 rover8))))
(always (or (not (at rover9 waypoint9)) (eventually (calibrated camera9 rover9))))
(until (not (communicated_soil_data waypoint21)) (communicated_soil_data waypoint14))
(until (not (communicated_soil_data waypoint16)) (communicated_soil_data waypoint21))
(until (not (communicated_rock_data waypoint9)) (communicated_soil_data waypoint16))
(until (not (communicated_rock_data waypoint2)) (communicated_rock_data waypoint9))
(until (not (communicated_rock_data waypoint10)) (communicated_rock_data waypoint2))
(until (not (communicated_rock_data waypoint7)) (communicated_rock_data waypoint10))
(until (not (communicated_image_data objective1 colour)) (communicated_rock_data waypoint7))
(until (not (communicated_image_data objective1 high_res)) (communicated_image_data objective1 colour))
(until (not (communicated_image_data objective2 colour)) (communicated_image_data objective1 high_res))
(eventually (communicated_image_data objective2 colour)))) 
