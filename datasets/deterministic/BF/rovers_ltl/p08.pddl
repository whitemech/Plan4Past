...
(:init
 ...
 (:goal (and 
(always (or (not (at rover1 waypoint0)) (eventually (calibrated camera2 rover1))))
(always (or (not (at rover2 waypoint0)) (eventually (calibrated camera3 rover2))))
(always (or (not (at rover3 waypoint0)) (and (eventually (calibrated camera0 rover3)) (eventually (calibrated camera1 rover3)))))
...
(until (not (communicated_rock_data waypoint5)) (communicated_soil_data waypoint4))
(until (not (communicated_rock_data waypoint4)) (communicated_rock_data waypoint5))
(until (not (communicated_image_data objective0 low_res)) (communicated_rock_data waypoint4))
(until (not (communicated_image_data objective0 high_res)) (communicated_image_data objective0 low_res))
(until (not (communicated_image_data objective2 low_res)) (communicated_image_data objective0 high_res))
