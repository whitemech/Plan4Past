...
(:init
 ...
 (:goal (and 
(always (or (not (at rover1 waypoint1)) (and (eventually (calibrated camera0 rover1)) (eventually (calibrated camera1 rover1)) (eventually (calibrated camera2 rover1)) (eventually (calibrated camera3 rover1)))))
(always (or (not (at rover2 waypoint1)) (eventually (calibrated camera4 rover2))))
(always (or (not (at rover3 waypoint1)) (eventually (calibrated camera5 rover3))))
(until (not (communicated_soil_data waypoint0)) (communicated_soil_data waypoint6))
(until (not (communicated_soil_data waypoint3)) (communicated_soil_data waypoint0))
(until (not (communicated_soil_data waypoint4)) (communicated_soil_data waypoint3))
(until (not (communicated_rock_data waypoint4)) (communicated_soil_data waypoint4))
(until (not (communicated_rock_data waypoint3)) (communicated_rock_data waypoint4))
(until (not (communicated_rock_data waypoint0)) (communicated_rock_data waypoint3))
(until (not (communicated_rock_data waypoint1)) (communicated_rock_data waypoint0))
(until (not (communicated_image_data objective3 colour)) (communicated_rock_data waypoint1))
(until (not (communicated_image_data objective2 colour)) (communicated_image_data objective3 colour))
(until (not (communicated_image_data objective3 low_res)) (communicated_image_data objective2 colour))
(eventually (communicated_image_data objective3 low_res)))) 
