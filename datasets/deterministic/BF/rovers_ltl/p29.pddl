...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint3)) (eventually (calibrated camera12 rover0))))
(always (or (not (at rover1 waypoint3)) (and (eventually (calibrated camera1 rover1)) (eventually (calibrated camera3 rover1)) (eventually (calibrated camera10 rover1)))))
(always (or (not (at rover3 waypoint3)) (eventually (calibrated camera13 rover3))))
(always (or (not (at rover4 waypoint3)) (and (eventually (calibrated camera0 rover4)) (eventually (calibrated camera9 rover4)))))
(always (or (not (at rover6 waypoint3)) (and (eventually (calibrated camera5 rover6)) (eventually (calibrated camera6 rover6)) (eventually (calibrated camera7 rover6)))))
(always (or (not (at rover7 waypoint3)) (eventually (calibrated camera4 rover7))))
(always (or (not (at rover8 waypoint3)) (and (eventually (calibrated camera2 rover8)) (eventually (calibrated camera8 rover8)) (eventually (calibrated camera11 rover8)))))
(always (or (not (at rover9 waypoint3)) (eventually (calibrated camera14 rover9))))
(until (not (communicated_soil_data waypoint14)) (communicated_soil_data waypoint9))
(until (not (communicated_soil_data waypoint28)) (communicated_soil_data waypoint14))
(until (not (communicated_soil_data waypoint2)) (communicated_soil_data waypoint28))
(until (not (communicated_soil_data waypoint23)) (communicated_soil_data waypoint2))
(until (not (communicated_soil_data waypoint26)) (communicated_soil_data waypoint23))
(until (not (communicated_rock_data waypoint23)) (communicated_soil_data waypoint26))
(until (not (communicated_rock_data waypoint18)) (communicated_rock_data waypoint23))
(until (not (communicated_rock_data waypoint11)) (communicated_rock_data waypoint18))
(until (not (communicated_rock_data waypoint36)) (communicated_rock_data waypoint11))
(until (not (communicated_image_data objective5 high_res)) (communicated_rock_data waypoint36))
(until (not (communicated_image_data objective3 colour)) (communicated_image_data objective5 high_res))
(until (not (communicated_image_data objective5 low_res)) (communicated_image_data objective3 colour))
(until (not (communicated_image_data objective3 high_res)) (communicated_image_data objective5 low_res))
(until (not (communicated_image_data objective1 high_res)) (communicated_image_data objective3 high_res))
(until (not (communicated_image_data objective7 colour)) (communicated_image_data objective1 high_res))
(eventually (communicated_image_data objective7 colour)))) 
