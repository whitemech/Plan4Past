...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint6)) (eventually (calibrated camera3 rover0))))
(always (or (not (at rover1 waypoint6)) (and (eventually (calibrated camera1 rover1)) (eventually (calibrated camera2 rover1)))))
(always (or (not (at rover2 waypoint6)) (eventually (calibrated camera0 rover2))))
(always (or (not (at rover3 waypoint6)) (eventually (calibrated camera5 rover3))))
(always (or (not (at rover4 waypoint6)) (eventually (calibrated camera4 rover4))))
(always (or (not (at rover5 waypoint6)) (eventually (calibrated camera6 rover5))))
(until (not (communicated_soil_data waypoint8)) (communicated_soil_data waypoint18))
(until (not (communicated_soil_data waypoint5)) (communicated_soil_data waypoint8))
(until (not (communicated_rock_data waypoint17)) (communicated_soil_data waypoint5))
(until (not (communicated_rock_data waypoint6)) (communicated_rock_data waypoint17))
(until (not (communicated_rock_data waypoint9)) (communicated_rock_data waypoint6))
(until (not (communicated_rock_data waypoint19)) (communicated_rock_data waypoint9))
(until (not (communicated_rock_data waypoint3)) (communicated_rock_data waypoint19))
(until (not (communicated_rock_data waypoint4)) (communicated_rock_data waypoint3))
(until (not (communicated_image_data objective7 low_res)) (communicated_rock_data waypoint4))
(until (not (communicated_image_data objective4 high_res)) (communicated_image_data objective7 low_res))
(until (not (communicated_image_data objective0 colour)) (communicated_image_data objective4 high_res))
(until (not (communicated_image_data objective6 low_res)) (communicated_image_data objective0 colour))
(until (not (communicated_image_data objective7 colour)) (communicated_image_data objective6 low_res))
(until (not (communicated_image_data objective2 low_res)) (communicated_image_data objective7 colour))
(until (not (communicated_image_data objective0 high_res)) (communicated_image_data objective2 low_res))
(until (not (communicated_image_data objective5 colour)) (communicated_image_data objective0 high_res))
(eventually (communicated_image_data objective5 colour)))) 
