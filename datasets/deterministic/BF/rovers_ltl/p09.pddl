...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint4)) (and (eventually (calibrated camera1 rover0)) (eventually (calibrated camera2 rover0)))))
(always (or (not (at rover1 waypoint4)) (eventually (calibrated camera4 rover1))))
(always (or (not (at rover2 waypoint4)) (eventually (calibrated camera3 rover2))))
(always (or (not (at rover3 waypoint4)) (eventually (calibrated camera0 rover3))))
(until (not (communicated_soil_data waypoint4)) (communicated_soil_data waypoint6))
(until (not (communicated_soil_data waypoint0)) (communicated_soil_data waypoint4))
(until (not (communicated_rock_data waypoint6)) (communicated_soil_data waypoint0))
(until (not (communicated_rock_data waypoint0)) (communicated_rock_data waypoint6))
(until (not (communicated_rock_data waypoint3)) (communicated_rock_data waypoint0))
(until (not (communicated_image_data objective2 low_res)) (communicated_rock_data waypoint3))
(until (not (communicated_image_data objective2 colour)) (communicated_image_data objective2 low_res))
