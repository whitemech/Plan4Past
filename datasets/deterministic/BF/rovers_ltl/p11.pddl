...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint1)) (eventually (calibrated camera3 rover0))))
(always (or (not (at rover1 waypoint1)) (eventually (calibrated camera0 rover1))))
(always (or (not (at rover2 waypoint1)) (eventually (calibrated camera1 rover2))))
(always (or (not (at rover3 waypoint1)) (eventually (calibrated camera2 rover3))))
(until (not (communicated_soil_data waypoint0)) (communicated_soil_data waypoint6))
(until (not (communicated_soil_data waypoint1)) (communicated_soil_data waypoint0))
(until (not (communicated_soil_data waypoint3)) (communicated_soil_data waypoint1))
(until (not (communicated_rock_data waypoint6)) (communicated_soil_data waypoint3))
(until (not (communicated_rock_data waypoint0)) (communicated_rock_data waypoint6))
(until (not (communicated_rock_data waypoint4)) (communicated_rock_data waypoint0))
(until (not (communicated_rock_data waypoint7)) (communicated_rock_data waypoint4))
(until (not (communicated_image_data objective1 high_res)) (communicated_rock_data waypoint7))
