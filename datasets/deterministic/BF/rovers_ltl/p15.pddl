...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint9)) (eventually (calibrated camera1 rover0))))
(always (or (not (at rover1 waypoint9)) (and (eventually (calibrated camera2 rover1)) (eventually (calibrated camera3 rover1)))))
(always (or (not (at rover3 waypoint9)) (eventually (calibrated camera0 rover3))))
(until (not (communicated_soil_data waypoint2)) (communicated_soil_data waypoint5))
(until (not (communicated_soil_data waypoint8)) (communicated_soil_data waypoint2))
(until (not (communicated_soil_data waypoint10)) (communicated_soil_data waypoint8))
(until (not (communicated_soil_data waypoint0)) (communicated_soil_data waypoint10))
(until (not (communicated_rock_data waypoint2)) (communicated_soil_data waypoint0))
(until (not (communicated_rock_data waypoint1)) (communicated_rock_data waypoint2))
(until (not (communicated_rock_data waypoint8)) (communicated_rock_data waypoint1))
(until (not (communicated_image_data objective1 low_res)) (communicated_rock_data waypoint8))
(until (not (communicated_image_data objective1 high_res)) (communicated_image_data objective1 low_res))
