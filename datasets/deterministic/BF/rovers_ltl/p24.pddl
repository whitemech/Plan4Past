...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint3)) (eventually (calibrated camera0 rover0))))
(always (or (not (at rover1 waypoint3)) (eventually (calibrated camera5 rover1))))
(always (or (not (at rover2 waypoint3)) (eventually (calibrated camera8 rover2))))
(always (or (not (at rover3 waypoint3)) (and (eventually (calibrated camera3 rover3)) (eventually (calibrated camera6 rover3)) (eventually (calibrated camera7 rover3)))))
(always (or (not (at rover5 waypoint3)) (eventually (calibrated camera4 rover5))))
(always (or (not (at rover6 waypoint3)) (eventually (calibrated camera2 rover6))))
(always (or (not (at rover7 waypoint3)) (eventually (calibrated camera1 rover7))))
(until (not (communicated_soil_data waypoint39)) (communicated_soil_data waypoint10))
(until (not (communicated_soil_data waypoint34)) (communicated_soil_data waypoint39))
(until (not (communicated_soil_data waypoint11)) (communicated_soil_data waypoint34))
(until (not (communicated_soil_data waypoint7)) (communicated_soil_data waypoint11))
(until (not (communicated_soil_data waypoint12)) (communicated_soil_data waypoint7))
(until (not (communicated_soil_data waypoint14)) (communicated_soil_data waypoint12))
(until (not (communicated_soil_data waypoint36)) (communicated_soil_data waypoint14))
(until (not (communicated_soil_data waypoint22)) (communicated_soil_data waypoint36))
(until (not (communicated_rock_data waypoint4)) (communicated_soil_data waypoint22))
(until (not (communicated_rock_data waypoint18)) (communicated_rock_data waypoint4))
(until (not (communicated_rock_data waypoint36)) (communicated_rock_data waypoint18))
(until (not (communicated_rock_data waypoint34)) (communicated_rock_data waypoint36))
(until (not (communicated_rock_data waypoint3)) (communicated_rock_data waypoint34))
(until (not (communicated_rock_data waypoint37)) (communicated_rock_data waypoint3))
(until (not (communicated_rock_data waypoint20)) (communicated_rock_data waypoint37))
(until (not (communicated_rock_data waypoint0)) (communicated_rock_data waypoint20))
(until (not (communicated_rock_data waypoint32)) (communicated_rock_data waypoint0))
(until (not (communicated_rock_data waypoint21)) (communicated_rock_data waypoint32))
(until (not (communicated_image_data objective4 colour)) (communicated_rock_data waypoint21))
(until (not (communicated_image_data objective1 low_res)) (communicated_image_data objective4 colour))
