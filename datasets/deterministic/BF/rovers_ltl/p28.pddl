...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint29)) (eventually (calibrated camera10 rover0))))
(always (or (not (at rover1 waypoint29)) (eventually (calibrated camera1 rover1))))
(always (or (not (at rover3 waypoint29)) (eventually (calibrated camera12 rover3))))
(always (or (not (at rover4 waypoint29)) (eventually (calibrated camera3 rover4))))
(always (or (not (at rover5 waypoint29)) (eventually (calibrated camera13 rover5))))
(always (or (not (at rover6 waypoint29)) (and (eventually (calibrated camera0 rover6)) (eventually (calibrated camera2 rover6)) (eventually (calibrated camera4 rover6)) (eventually (calibrated camera7 rover6)))))
(always (or (not (at rover7 waypoint29)) (eventually (calibrated camera11 rover7))))
(always (or (not (at rover9 waypoint29)) (and (eventually (calibrated camera5 rover9)) (eventually (calibrated camera8 rover9)) (eventually (calibrated camera9 rover9)))))
(until (not (communicated_soil_data waypoint28)) (communicated_soil_data waypoint10))
(until (not (communicated_soil_data waypoint2)) (communicated_soil_data waypoint28))
(until (not (communicated_soil_data waypoint24)) (communicated_soil_data waypoint2))
(until (not (communicated_soil_data waypoint15)) (communicated_soil_data waypoint24))
(until (not (communicated_soil_data waypoint17)) (communicated_soil_data waypoint15))
(until (not (communicated_soil_data waypoint3)) (communicated_soil_data waypoint17))
(until (not (communicated_soil_data waypoint0)) (communicated_soil_data waypoint3))
(until (not (communicated_rock_data waypoint4)) (communicated_soil_data waypoint0))
(until (not (communicated_rock_data waypoint17)) (communicated_rock_data waypoint4))
(until (not (communicated_rock_data waypoint33)) (communicated_rock_data waypoint17))
(until (not (communicated_rock_data waypoint24)) (communicated_rock_data waypoint33))
(until (not (communicated_rock_data waypoint27)) (communicated_rock_data waypoint24))
(until (not (communicated_rock_data waypoint18)) (communicated_rock_data waypoint27))
(until (not (communicated_image_data objective7 high_res)) (communicated_rock_data waypoint18))
(until (not (communicated_image_data objective5 low_res)) (communicated_image_data objective7 high_res))
(until (not (communicated_image_data objective4 low_res)) (communicated_image_data objective5 low_res))
(until (not (communicated_image_data objective4 high_res)) (communicated_image_data objective4 low_res))
(until (not (communicated_image_data objective2 low_res)) (communicated_image_data objective4 high_res))
(eventually (communicated_image_data objective2 low_res)))) 
