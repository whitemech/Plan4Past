...
(:init
 ...
 (:goal (and 
(always (or (not (at rover1 waypoint17)) (eventually (calibrated camera0 rover1))))
(always (or (not (at rover2 waypoint17)) (eventually (calibrated camera1 rover2))))
(always (or (not (at rover3 waypoint17)) (and (eventually (calibrated camera3 rover3)) (eventually (calibrated camera4 rover3)))))
(always (or (not (at rover4 waypoint17)) (eventually (calibrated camera2 rover4))))
(always (or (not (at rover5 waypoint17)) (eventually (calibrated camera6 rover5))))
(until (not (communicated_soil_data waypoint0)) (communicated_soil_data waypoint14))
(until (not (communicated_rock_data waypoint4)) (communicated_soil_data waypoint0))
(until (not (communicated_rock_data waypoint7)) (communicated_rock_data waypoint4))
(until (not (communicated_rock_data waypoint2)) (communicated_rock_data waypoint7))
(until (not (communicated_rock_data waypoint5)) (communicated_rock_data waypoint2))
(until (not (communicated_rock_data waypoint6)) (communicated_rock_data waypoint5))
(until (not (communicated_image_data objective5 colour)) (communicated_rock_data waypoint6))
(until (not (communicated_image_data objective3 low_res)) (communicated_image_data objective5 colour))
(until (not (communicated_image_data objective2 colour)) (communicated_image_data objective3 low_res))
(until (not (communicated_image_data objective4 high_res)) (communicated_image_data objective2 colour))
(eventually (communicated_image_data objective4 high_res)))) 
