...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint31)) (eventually (calibrated camera3 rover0))))
(always (or (not (at rover1 waypoint31)) (eventually (calibrated camera8 rover1))))
(always (or (not (at rover2 waypoint31)) (and (eventually (calibrated camera0 rover2)) (eventually (calibrated camera6 rover2)) (eventually (calibrated camera7 rover2)))))
(always (or (not (at rover4 waypoint31)) (and (eventually (calibrated camera1 rover4)) (eventually (calibrated camera5 rover4)))))
(always (or (not (at rover5 waypoint31)) (eventually (calibrated camera4 rover5))))
(until (not (communicated_soil_data waypoint0)) (communicated_soil_data waypoint23))
(until (not (communicated_soil_data waypoint14)) (communicated_soil_data waypoint0))
(until (not (communicated_soil_data waypoint34)) (communicated_soil_data waypoint14))
(until (not (communicated_soil_data waypoint18)) (communicated_soil_data waypoint34))
(until (not (communicated_soil_data waypoint16)) (communicated_soil_data waypoint18))
(until (not (communicated_soil_data waypoint12)) (communicated_soil_data waypoint16))
(until (not (communicated_soil_data waypoint6)) (communicated_soil_data waypoint12))
(until (not (communicated_rock_data waypoint24)) (communicated_soil_data waypoint6))
(until (not (communicated_rock_data waypoint33)) (communicated_rock_data waypoint24))
(until (not (communicated_rock_data waypoint9)) (communicated_rock_data waypoint33))
(until (not (communicated_image_data objective4 high_res)) (communicated_rock_data waypoint9))
(until (not (communicated_image_data objective3 high_res)) (communicated_image_data objective4 high_res))
(until (not (communicated_image_data objective7 colour)) (communicated_image_data objective3 high_res))
