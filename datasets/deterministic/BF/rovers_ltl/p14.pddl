...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint7)) (eventually (calibrated camera4 rover0))))
(always (or (not (at rover1 waypoint7)) (and (eventually (calibrated camera2 rover1)) (eventually (calibrated camera3 rover1)))))
(always (or (not (at rover3 waypoint7)) (eventually (calibrated camera0 rover3))))
(until (not (communicated_soil_data waypoint6)) (communicated_soil_data waypoint3))
(until (not (communicated_rock_data waypoint5)) (communicated_soil_data waypoint6))
(until (not (communicated_rock_data waypoint4)) (communicated_rock_data waypoint5))
(until (not (communicated_rock_data waypoint8)) (communicated_rock_data waypoint4))
(until (not (communicated_image_data objective0 colour)) (communicated_rock_data waypoint8))
(until (not (communicated_image_data objective2 low_res)) (communicated_image_data objective0 colour))
(until (not (communicated_image_data objective0 low_res)) (communicated_image_data objective2 low_res))
