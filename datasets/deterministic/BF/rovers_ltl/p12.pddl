...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint2)) (eventually (calibrated camera2 rover0))))
(always (or (not (at rover2 waypoint2)) (eventually (calibrated camera1 rover2))))
(always (or (not (at rover3 waypoint2)) (and (eventually (calibrated camera0 rover3)) (eventually (calibrated camera3 rover3)))))
(until (not (communicated_rock_data waypoint3)) (communicated_soil_data waypoint0))
(until (not (communicated_rock_data waypoint6)) (communicated_rock_data waypoint3))
(until (not (communicated_image_data objective2 low_res)) (communicated_rock_data waypoint6))
(until (not (communicated_image_data objective1 high_res)) (communicated_image_data objective2 low_res))
(until (not (communicated_image_data objective3 low_res)) (communicated_image_data objective1 high_res))
