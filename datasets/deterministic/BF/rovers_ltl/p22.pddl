...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint2)) (eventually (calibrated camera5 rover0))))
(always (or (not (at rover1 waypoint2)) (eventually (calibrated camera3 rover1))))
(always (or (not (at rover2 waypoint2)) (and (eventually (calibrated camera6 rover2)) (eventually (calibrated camera7 rover2)))))
(always (or (not (at rover3 waypoint2)) (and (eventually (calibrated camera0 rover3)) (eventually (calibrated camera1 rover3)))))
(always (or (not (at rover4 waypoint2)) (eventually (calibrated camera2 rover4))))
(always (or (not (at rover5 waypoint2)) (eventually (calibrated camera4 rover5))))
(until (not (communicated_soil_data waypoint3)) (communicated_soil_data waypoint17))
(until (not (communicated_soil_data waypoint18)) (communicated_soil_data waypoint3))
(until (not (communicated_soil_data waypoint1)) (communicated_soil_data waypoint18))
(until (not (communicated_soil_data waypoint38)) (communicated_soil_data waypoint1))
(until (not (communicated_rock_data waypoint14)) (communicated_soil_data waypoint38))
(until (not (communicated_rock_data waypoint21)) (communicated_rock_data waypoint14))
(until (not (communicated_rock_data waypoint24)) (communicated_rock_data waypoint21))
(until (not (communicated_rock_data waypoint7)) (communicated_rock_data waypoint24))
(until (not (communicated_rock_data waypoint31)) (communicated_rock_data waypoint7))
(until (not (communicated_rock_data waypoint25)) (communicated_rock_data waypoint31))
(until (not (communicated_image_data objective6 low_res)) (communicated_rock_data waypoint25))
(until (not (communicated_image_data objective9 high_res)) (communicated_image_data objective6 low_res))
(until (not (communicated_image_data objective8 high_res)) (communicated_image_data objective9 high_res))
(until (not (communicated_image_data objective3 high_res)) (communicated_image_data objective8 high_res))
(until (not (communicated_image_data objective1 low_res)) (communicated_image_data objective3 high_res))
