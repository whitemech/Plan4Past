...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint6)) (eventually (calibrated camera2 rover0))))
(always (or (not (at rover2 waypoint6)) (and (eventually (calibrated camera0 rover2)) (eventually (calibrated camera1 rover2)) (eventually (calibrated camera3 rover2)))))
(until (not (communicated_soil_data waypoint9)) (communicated_soil_data waypoint4))
(until (not (communicated_soil_data waypoint1)) (communicated_soil_data waypoint9))
(until (not (communicated_soil_data waypoint7)) (communicated_soil_data waypoint1))
(until (not (communicated_rock_data waypoint3)) (communicated_soil_data waypoint7))
(until (not (communicated_rock_data waypoint10)) (communicated_rock_data waypoint3))
(until (not (communicated_rock_data waypoint5)) (communicated_rock_data waypoint10))
(until (not (communicated_rock_data waypoint1)) (communicated_rock_data waypoint5))
(until (not (communicated_image_data objective0 high_res)) (communicated_rock_data waypoint1))
(until (not (communicated_image_data objective4 high_res)) (communicated_image_data objective0 high_res))
(until (not (communicated_image_data objective2 high_res)) (communicated_image_data objective4 high_res))
