...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint6)) (eventually (calibrated camera10 rover0))))
(always (or (not (at rover1 waypoint6)) (eventually (calibrated camera11 rover1))))
(always (or (not (at rover4 waypoint6)) (eventually (calibrated camera12 rover4))))
(always (or (not (at rover6 waypoint6)) (eventually (calibrated camera4 rover6))))
(always (or (not (at rover7 waypoint6)) (and (eventually (calibrated camera5 rover7)) (eventually (calibrated camera8 rover7)) (eventually (calibrated camera9 rover7)))))
(always (or (not (at rover8 waypoint6)) (and (eventually (calibrated camera0 rover8)) (eventually (calibrated camera3 rover8)))))
(always (or (not (at rover9 waypoint6)) (eventually (calibrated camera2 rover9))))
(until (not (communicated_soil_data waypoint3)) (communicated_soil_data waypoint25))
(until (not (communicated_soil_data waypoint14)) (communicated_soil_data waypoint3))
(until (not (communicated_soil_data waypoint21)) (communicated_soil_data waypoint14))
(until (not (communicated_soil_data waypoint32)) (communicated_soil_data waypoint21))
(until (not (communicated_soil_data waypoint10)) (communicated_soil_data waypoint32))
(until (not (communicated_soil_data waypoint8)) (communicated_soil_data waypoint10))
(until (not (communicated_soil_data waypoint0)) (communicated_soil_data waypoint8))
(until (not (communicated_rock_data waypoint32)) (communicated_soil_data waypoint0))
(until (not (communicated_rock_data waypoint29)) (communicated_rock_data waypoint32))
(until (not (communicated_rock_data waypoint28)) (communicated_rock_data waypoint29))
(until (not (communicated_rock_data waypoint11)) (communicated_rock_data waypoint28))
(until (not (communicated_rock_data waypoint10)) (communicated_rock_data waypoint11))
(until (not (communicated_rock_data waypoint9)) (communicated_rock_data waypoint10))
(until (not (communicated_rock_data waypoint4)) (communicated_rock_data waypoint9))
(until (not (communicated_rock_data waypoint26)) (communicated_rock_data waypoint4))
(until (not (communicated_image_data objective7 colour)) (communicated_rock_data waypoint26))
(until (not (communicated_image_data objective5 high_res)) (communicated_image_data objective7 colour))
(until (not (communicated_image_data objective5 colour)) (communicated_image_data objective5 high_res))
(until (not (communicated_image_data objective0 high_res)) (communicated_image_data objective5 colour))
(eventually (communicated_image_data objective0 high_res)))) 
