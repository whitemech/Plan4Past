...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint2)) (eventually (calibrated camera4 rover0))))
(always (or (not (at rover1 waypoint2)) (eventually (calibrated camera3 rover1))))
(always (or (not (at rover2 waypoint2)) (and (eventually (calibrated camera0 rover2)) (eventually (calibrated camera1 rover2)))))
(always (or (not (at rover3 waypoint2)) (eventually (calibrated camera2 rover3))))
(until (not (communicated_soil_data waypoint5)) (communicated_soil_data waypoint7))
...
(until (not (communicated_rock_data waypoint4)) (communicated_soil_data waypoint4))
(until (not (communicated_rock_data waypoint6)) (communicated_rock_data waypoint4))
(until (not (communicated_rock_data waypoint7)) (communicated_rock_data waypoint6))
(until (not (communicated_rock_data waypoint8)) (communicated_rock_data waypoint7))
(until (not (communicated_rock_data waypoint1)) (communicated_rock_data waypoint8))
(until (not (communicated_image_data objective3 high_res)) (communicated_rock_data waypoint1))
(until (not (communicated_image_data objective1 high_res)) (communicated_image_data objective3 high_res))
(until (not (communicated_image_data objective2 high_res)) (communicated_image_data objective1 high_res))
(eventually (communicated_image_data objective2 high_res)))) 
