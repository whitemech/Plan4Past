...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint1)) (eventually (calibrated camera0 rover0))))
(always (or (not (at rover1 waypoint1)) (and (eventually (calibrated camera1 rover1)) (eventually (calibrated camera4 rover1)))))
(always (or (not (at rover2 waypoint1)) (eventually (calibrated camera3 rover2))))
(always (or (not (at rover4 waypoint1)) (eventually (calibrated camera2 rover4))))
(always (or (not (at rover5 waypoint1)) (eventually (calibrated camera5 rover5))))
(always (or (not (at rover6 waypoint1)) (eventually (calibrated camera6 rover6))))
(until (not (communicated_soil_data waypoint23)) (communicated_soil_data waypoint8))
(until (not (communicated_soil_data waypoint7)) (communicated_soil_data waypoint23))
(until (not (communicated_soil_data waypoint11)) (communicated_soil_data waypoint7))
(until (not (communicated_soil_data waypoint13)) (communicated_soil_data waypoint11))
(until (not (communicated_soil_data waypoint20)) (communicated_soil_data waypoint13))
(until (not (communicated_rock_data waypoint7)) (communicated_soil_data waypoint20))
(until (not (communicated_rock_data waypoint14)) (communicated_rock_data waypoint7))
(until (not (communicated_rock_data waypoint22)) (communicated_rock_data waypoint14))
(until (not (communicated_rock_data waypoint16)) (communicated_rock_data waypoint22))
(until (not (communicated_rock_data waypoint12)) (communicated_rock_data waypoint16))
(until (not (communicated_rock_data waypoint10)) (communicated_rock_data waypoint12))
(until (not (communicated_rock_data waypoint9)) (communicated_rock_data waypoint10))
(until (not (communicated_rock_data waypoint21)) (communicated_rock_data waypoint9))
(until (not (communicated_rock_data waypoint18)) (communicated_rock_data waypoint21))
(until (not (communicated_image_data objective2 high_res)) (communicated_rock_data waypoint18))
(until (not (communicated_image_data objective0 high_res)) (communicated_image_data objective2 high_res))
(until (not (communicated_image_data objective3 colour)) (communicated_image_data objective0 high_res))
(until (not (communicated_image_data objective7 colour)) (communicated_image_data objective3 colour))
(until (not (communicated_image_data objective5 high_res)) (communicated_image_data objective7 colour))
(eventually (communicated_image_data objective5 high_res)))) 
