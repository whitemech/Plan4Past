...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint35)) (eventually (calibrated camera10 rover0))))
(always (or (not (at rover1 waypoint35)) (and (eventually (calibrated camera3 rover1)) (eventually (calibrated camera6 rover1)))))
(always (or (not (at rover2 waypoint35)) (and (eventually (calibrated camera1 rover2)) (eventually (calibrated camera2 rover2)) (eventually (calibrated camera5 rover2)) (eventually (calibrated camera8 rover2)))))
(always (or (not (at rover4 waypoint35)) (eventually (calibrated camera4 rover4))))
(always (or (not (at rover5 waypoint35)) (eventually (calibrated camera9 rover5))))
(always (or (not (at rover7 waypoint35)) (eventually (calibrated camera7 rover7))))
(until (not (communicated_soil_data waypoint34)) (communicated_soil_data waypoint21))
(until (not (communicated_soil_data waypoint26)) (communicated_soil_data waypoint34))
(until (not (communicated_soil_data waypoint22)) (communicated_soil_data waypoint26))
(until (not (communicated_soil_data waypoint27)) (communicated_soil_data waypoint22))
(until (not (communicated_soil_data waypoint5)) (communicated_soil_data waypoint27))
(until (not (communicated_soil_data waypoint9)) (communicated_soil_data waypoint5))
(until (not (communicated_rock_data waypoint9)) (communicated_soil_data waypoint9))
(until (not (communicated_rock_data waypoint27)) (communicated_rock_data waypoint9))
(until (not (communicated_rock_data waypoint15)) (communicated_rock_data waypoint27))
(until (not (communicated_rock_data waypoint20)) (communicated_rock_data waypoint15))
(until (not (communicated_rock_data waypoint18)) (communicated_rock_data waypoint20))
(until (not (communicated_rock_data waypoint2)) (communicated_rock_data waypoint18))
(until (not (communicated_image_data objective2 high_res)) (communicated_rock_data waypoint2))
(until (not (communicated_image_data objective6 low_res)) (communicated_image_data objective2 high_res))
(until (not (communicated_image_data objective8 high_res)) (communicated_image_data objective6 low_res))
(until (not (communicated_image_data objective0 colour)) (communicated_image_data objective8 high_res))
(until (not (communicated_image_data objective5 colour)) (communicated_image_data objective0 colour))
(until (not (communicated_image_data objective0 low_res)) (communicated_image_data objective5 colour))
