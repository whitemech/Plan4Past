...
(:init
 ...
 (:goal (and 
(always (or (not (at rover0 waypoint27)) (eventually (calibrated camera4 rover0))))
(always (or (not (at rover1 waypoint27)) (eventually (calibrated camera6 rover1))))
(always (or (not (at rover3 waypoint27)) (eventually (calibrated camera1 rover3))))
(always (or (not (at rover4 waypoint27)) (eventually (calibrated camera2 rover4))))
(always (or (not (at rover5 waypoint27)) (eventually (calibrated camera0 rover5))))
(always (or (not (at rover7 waypoint27)) (eventually (calibrated camera3 rover7))))
(always (or (not (at rover9 waypoint27)) (eventually (calibrated camera5 rover9))))
(until (not (communicated_soil_data waypoint2)) (communicated_soil_data waypoint24))
(until (not (communicated_soil_data waypoint1)) (communicated_soil_data waypoint2))
(until (not (communicated_soil_data waypoint12)) (communicated_soil_data waypoint1))
(until (not (communicated_soil_data waypoint11)) (communicated_soil_data waypoint12))
(until (not (communicated_soil_data waypoint21)) (communicated_soil_data waypoint11))
(until (not (communicated_soil_data waypoint3)) (communicated_soil_data waypoint21))
(until (not (communicated_soil_data waypoint25)) (communicated_soil_data waypoint3))
(until (not (communicated_rock_data waypoint6)) (communicated_soil_data waypoint25))
(until (not (communicated_rock_data waypoint28)) (communicated_rock_data waypoint6))
(until (not (communicated_rock_data waypoint20)) (communicated_rock_data waypoint28))
(until (not (communicated_image_data objective1 low_res)) (communicated_rock_data waypoint20))
(until (not (communicated_image_data objective5 high_res)) (communicated_image_data objective1 low_res))
(until (not (communicated_image_data objective0 high_res)) (communicated_image_data objective5 high_res))
