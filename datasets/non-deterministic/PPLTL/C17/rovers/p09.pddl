(define (problem problem5)
  ...
  ; (:goal  (eventually(always(or (always(communicatedsoildata waypoint0))
  ;                    (always(communicatedsoildata waypoint2))
  ;                    (always(communicatedrockdata waypoint3))
  ;                    (always(communicatedimagedata objective1 highres))                    
  ;                )
  ;         ))
  ; )
(:goal (and ))
